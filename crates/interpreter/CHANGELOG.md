...
## [23.0.3](https://github.com/Troublor/revm/compare/revm-interpreter-v23.0.2...revm-interpreter-v23.0.3) - 2025-07-20

### Other

- add release safety section for SharedMemory fn ([#2718](https://github.com/Troublor/revm/pull/2718))
- *(interpreter)* update docs for slice_mut and slice_range ([#2714](https://github.com/Troublor/revm/pull/2714))
