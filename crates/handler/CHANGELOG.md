...
## [8.1.0](https://github.com/Troublor/revm/compare/revm-handler-v8.0.3...revm-handler-v8.1.0) - 2025-07-20

### Added

- add a way for precompiles to revert ([#2711](https://github.com/Troublor/revm/pull/2711))

### Other

- change gas parameter to immutable reference ([#2702](https://github.com/Troublor/revm/pull/2702))
- remove State bound from JournalTr in Handler::Evm ([#2715](https://github.com/Troublor/revm/pull/2715))
